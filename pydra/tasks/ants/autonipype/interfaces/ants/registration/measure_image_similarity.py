...
class MeasureImageSimilarity(shell.Task["MeasureImageSimilarity.Outputs"]):
    ...
    >>> from fileformats.generic import File
    >>> from fileformats.medimage import Nifti1
    >>> from pydra.tasks.ants.autonipype.interfaces.ants.registration.measure_image_similarity import MeasureImageSimilarity
...
def _mask_constructor(moving_image_mask=None, fixed_image_mask=None):
