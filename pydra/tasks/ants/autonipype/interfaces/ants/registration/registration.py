...
import logging
from pydra.tasks.ants.auto.nipype_ports.utils.filemanip import ensure_list
import os
...
@shell.define(
    xor=[
        ...
        ["fixed_image_masks", "fixed_image_mask"],
...
class Registration(shell.Task["Registration.Outputs"]):
    ...
    >>> from pathlib._local import Path
    >>> import pprint
    >>> from pydra.tasks.ants.autonipype.interfaces.ants.registration.registration import Registration
    >>> from pydra.utils.typing import MultiInputObj
