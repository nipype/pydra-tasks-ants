...
import logging
from pydra.tasks.ants.auto.nipype_ports.utils.filemanip import fname_presuffix
import os
...
class N4BiasFieldCorrection(shell.Task["N4BiasFieldCorrection.Outputs"]):
    ...
    >>> from fileformats.medimage import Nifti1
    >>> from pathlib._local import Path
    >>> from pydra.tasks.ants.autonipype.interfaces.ants.segmentation.n4_bias_field_correction import N4BiasFieldCorrection
