...
import logging
from pydra.tasks.ants.auto.nipype_ports.utils.filemanip import split_filename
import os
...
@shell.define(xor=[["tightest_box", "reference_image"]])
class WarpTimeSeriesImageMultiTransform(
    ...
    >>> from fileformats.generic import File
    >>> from fileformats.medimage import Nifti1, NiftiGz
    >>> from pydra.tasks.ants.autonipype.interfaces.ants.resampling.warp_time_series_image_multi_transform import WarpTimeSeriesImageMultiTransform
