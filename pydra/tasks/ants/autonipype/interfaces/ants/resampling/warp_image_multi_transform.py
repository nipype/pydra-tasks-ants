...
@shell.define(
    xor=[["out_postfix", "output_image"], ["tightest_box", "reference_image"]]
)
class WarpImageMultiTransform(shell.Task["WarpImageMultiTransform.Outputs"]):
    ...
    >>> from fileformats.text import TextFile
    >>> from pathlib._local import Path
    >>> from pydra.tasks.ants.autonipype.interfaces.ants.resampling.warp_image_multi_transform import WarpImageMultiTransform
